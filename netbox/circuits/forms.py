...
class ProviderBulkEditForm(BootstrapMixin, CustomFieldBulkEditForm):
    ...
    account = forms.CharField(
        max_length=30, required=False, label='Account number')
