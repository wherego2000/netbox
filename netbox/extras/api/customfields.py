...
class CustomFieldsSerializer(serializers.BaseSerializer):
    ...
    def to_internal_value(self, data):
        ...
        custom_fields = {field.name: field for field in CustomField.objects.filter(
...
class CustomFieldModelSerializer(ValidatedModelSerializer):
        ...
        def _populate_custom_fields(instance, fields):
            ...
            for cfv in instance.custom_field_values.all():
                if cfv.field.type == CF_TYPE_SELECT:
                    custom_fields[cfv.field.name] = CustomFieldChoiceSerializer(
                        cfv.value).data
                else:
    ...
    def create(self, validated_data):
        ...
        with transaction.atomic():
            ...
            instance = super(CustomFieldModelSerializer,
    ...
    def update(self, instance, validated_data):
        ...
        with transaction.atomic():
            ...
            instance = super(CustomFieldModelSerializer, self).update(
